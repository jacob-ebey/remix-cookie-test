    ...
    <Layout>
      <div className="login-form bg-gray-100 rounded-lg p-8 md:ml-auto mt-10 md:mt-12 w-5/12 m-auto">
        ...
        <div className="mb-4 text-gray-900 text-sm">
          Login, with username/password in chrome - see cookies get saved in storage. Try refreshing the page, the cookies should get removed for an unknown reason. I've tested this with a default remix installation and same behavior.
        </div>
