...
var Login = () => {
  ...
  async function handleSubmit(event) {
    ...
    if (data.params) {
      console.log("do not navigate, trying to debug cookie issue");
      return;
    }
  ...
  }, /* @__PURE__ */ React5.createElement("p", null, "username: remix"), /* @__PURE__ */ React5.createElement("p", null, "password: test")), /* @__PURE__ */ React5.createElement("div", {
    className: "mb-4 text-gray-900 text-sm"
  }, "Login, with username/password in chrome - see cookies get saved in storage. Try refreshing the page, the cookies should get removed for an unknown reason. I've tested this with a default remix installation and same behavior."), /* @__PURE__ */ React5.createElement("form", {
